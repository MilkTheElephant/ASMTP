...
nnoremap <M-Right> :normal =SwitchWindow('>')
nnoremap <M-Left> :normal =SwitchWindow('<')
nnoremap <M-Down> :normal =SwitchWindow('-')
nnoremap <M-Up> :normal =SwitchWindow('+')
...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/bundles,~/.vim/bundle/lightline.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-surround,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set shiftwidth=4
set showtabline=2
set statusline=%f[%{strlen(&fenc)?&fenc:'none'},%{&ff}]%y%h%m%r
